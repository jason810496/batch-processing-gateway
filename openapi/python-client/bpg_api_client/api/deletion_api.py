...
class DeletionApi:
    ...
    def delete_submission(
        self,
        submission_id: Annotated[StrictStr, Field(description="The submission ID returned by submission API")],
        ...
        :param submission_id: The submission ID returned by submission API (required)
    ...
    def delete_submission_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteSubmissionResponse]:
        """Delete Spark application by submission ID
    ...
    def _delete_submission_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/spark/{submissionId}',
